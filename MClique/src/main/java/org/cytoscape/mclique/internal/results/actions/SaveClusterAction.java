...
import org.cytoscape.mclique.internal.results.io.ClusteringWriter;
...
public class SaveClusterAction extends AbstractAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (format == null) {
                        JOptionPane.showMessageDialog(null, "The extension of the given filename does not correspond to any of the known formats. ", ".csv for CSV mclique lists, .txt for mclique lists ", JOptionPane.WARNING_MESSAGE);
			return;
		}
		...
		try {
			wr.writeClustering(this.getNodeListsToBeSaved(), file);
                        ...
                        JOptionPane.showMessageDialog(null, "I/O error", "error while trying to save the selected maximal  to\n" +file.getAbsolutePath(), JOptionPane.WARNING_MESSAGE);
		}
	}
}
