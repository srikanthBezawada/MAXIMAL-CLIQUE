...
import org.cytoscape.mclique.internal.results.renderer.HeightLimitedJLabelRenderer;
import org.cytoscape.mclique.internal.util.StringUtils;
...
public class ResultViewerPanel extends JPanel implements TableModelListener {
	 ...
	 * Constructor
	 */
	public ResultViewerPanel(List<MClique> nodeSets) {
	 ...
	 * result viewer table.
	 */
	public List<MClique> getAllNodeSets() {
		NodeSetTableModel model = this.getTableModel();
		int numRows = model.getRowCount();
		
		List<MClique> result = new ArrayList<MClique>();
	 ...
	 */
	public MClique getSelectedNodeSet() {
	 ...
	 */
	public List<MClique> getSelectedNodeSets() {
		NodeSetTableModel model = this.getTableModel();
		List<MClique> result = new ArrayList<MClique>();
	 ...
	 */
	public void setNodeSets(List<MClique> set) {
	...
	private void updateCounterLabel() {
		...
		if (n == 0)
			countLabel.setText("No Maximal Cliques");
		else if (n == 1)
			countLabel.setText("1 Maximal Clique");
		else
			countLabel.setText(n+" Maximal Cliques");
	}
