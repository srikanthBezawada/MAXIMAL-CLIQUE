package org.cytoscape.mclique.internal.view;
...
import org.cytoscape.mclique.internal.logic.MCliqueLogic;
...
public class MCliqueUI extends javax.swing.JPanel implements CytoPanelComponent, NetworkAddedListener, NetworkDestroyedListener {
    ...
    private MCliqueLogic logicThread;
            
    public MCliqueUI(CyServiceRegistrar cyRegistrar) {
        initComponents();
    ...
    public void resultsCalculated(Collection<MClique> finalResultMerged, CyNetwork network) {
        
        CytoscapeResultViewerPanel resultsPanel = new CytoscapeResultViewerPanel(cyRegistrar, network);
        resultsPanel.setResult(new ArrayList<MClique>(finalResultMerged));
    ...
    public void startComputation(){
        ...
        statusLabel.setText("Finding Cliques ......");
    }
    ...
    private void initComponents() {
        ...
        startB.setText("Find MaximalCliques on selected network");
        ...
        helpButton.setFont(new java.awt.Font("Times New Roman", 1, 11)); // NOI18N
        ...
        exitButton.setFont(new java.awt.Font("Times New Roman", 1, 11)); // NOI18N
    ...
    private void startBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startBActionPerformed
        ...
        if(network != null){
            ...
            logicThread = new MCliqueLogic(this, network, networkview);
            logicThread.start();
    ...
    private void helpButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_helpButtonActionPerformed
        // TODO
        openBrowser.openURL("http://apps.cytoscape.org/apps/mclique");
