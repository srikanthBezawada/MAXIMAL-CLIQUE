...
import org.cytoscape.mclique.internal.results.standardgraph.Graph;
...
public class NodeSetTableModel extends AbstractTableModel {
    ...
    protected List<MClique> nodeSets = new ArrayList<MClique>();
    ...
    */
    public NodeSetTableModel(List<MClique> nodeSets) {
    ...
    */
    public String[] getMemberNames(int row) {
            MClique nodeSet = this.nodeSets.get(row);
            if (nodeSet == null)
                    return new String[0];
	 ...
	 */
	public MClique getNodeSetByIndex(int row) {
	 ...
	 */
	public void remove(MClique nodeSet) {
	...
	public void setProgressIcon(Icon value) {
        ...
        public Graph convertCyNetworkToGraph(CyNetwork network, String weightAttr) {
                org.cytoscape.mclique.internal.results.Graph graph = new org.cytoscape.mclique.internal.results.Graph(network);
