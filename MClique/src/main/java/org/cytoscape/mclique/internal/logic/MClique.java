...
import org.cytoscape.mclique.internal.util.CyNodeUtil;
...
public class MClique {
    ...
    public MClique(CyNetwork subnetwork) {
    ...
    public boolean equals(Object otherComplex) {
        if (!(otherComplex instanceof MClique)) {
            return false;
        }    
        MClique otherComplexRef = (MClique)otherComplex;
